...
*/
	function success(){
		...
		*/							
		...
		if(newM==2){ $(".goTop").css("background","#17b9ff").removeClass("hlink")}
		if(newM>2&&newM<8){ $(".goTop").css("background","#86ba00").removeClass("hlink")}
		else if(newM>=8&&newM<15){ $(".goTop").css("background","#ff4a1b").removeClass("hlink")}
		else if(newM>=15&&newM<18){ $(".goTop").css("background","#7221ed").removeClass("hlink")}
		else if(newM>=18&&newM<22){ $(".goTop").css("background","#fd1f78").removeClass("hlink")} 
		else if(newM==22){ $(".goTop").css("background","#df3031").removeClass("hlink")} 
...
function goHomeFun(){
	...
	** 返回首页的函数
	*/
	$(".m-page").removeClass("show active").addClass("hide");
	$(".m-page").eq(0).removeClass("active hide").addClass("show");
	...
	$(".goTop").addClass("hlink");//ylj
}
function goChoseFun(choseNum){
	/*
	** 跳到指定page的函数
	*/
	$(".m-page").removeClass("show active").addClass("hide");
	$(".m-page").eq(choseNum).removeClass("active hide").addClass("show");
	// 滑动成功加载多面的图片
	lazy_bigP();
	//重新设置页面移动的控制值
	page_n = choseNum + 1;
	...
	//ylj
	if(choseNum==1){ $(".goTop").css("background","#17b9ff").removeClass("hlink")}
	if(choseNum==2){ $(".goTop").css("background","#86ba00").removeClass("hlink")}
	else if(choseNum>2&&choseNum<=7){ $(".goTop").css("background","#ff4a1b").removeClass("hlink")}
	else if(choseNum>7&&choseNum<=14){ $(".goTop").css("background","#7221ed").removeClass("hlink")}
	else if(choseNum>14&&choseNum<=17){ $(".goTop").css("background","#fd1f78").removeClass("hlink")} 
	else if(choseNum>17&&choseNum<=21){ $(".goTop").css("background","#df3031").removeClass("hlink")} 
}	
/*
**设备旋转提示
*/
